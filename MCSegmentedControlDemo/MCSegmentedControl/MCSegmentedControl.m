...
//@property (nonatomic, retain) NSArray *_unSelectedItemBackgroundGradientCGColors;
...
- (void)_initialize
{
    ...
    self.unSelectedItemBackgroundGradientColors = @[[UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0],
...
{
    return _unSelectedItemBackgroundGradientColors;
}
...
- (void)setUnSelectedItemBackgroundGradientColors:(NSArray *)array
{
    if (array && [array count] != 2) {
        ...
        //			_unSelectedItemBackgroundGradientColors = [[NSArray alloc] initWithObjects:
        ...
        //		}
        //		else {
        //			[_unSelectedItemBackgroundGradientColors release], _unSelectedItemBackgroundGradientColors = nil;
        //		}
    }
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_unSelectedItemBackgroundGradientColors) {
        ...
        NSArray *gradientColors = @[(id)((UIColor *)_unSelectedItemBackgroundGradientColors[0]).CGColor,
                                    (id)((UIColor *)_unSelectedItemBackgroundGradientColors[1]).CGColor];
    ...
    for (int i = 0; i < self.numberOfSegments; i++) {
        ...
        if ([item isKindOfClass:[UIImage class]]) {
            ...
            NSString *string = (NSString *)_items[i];
